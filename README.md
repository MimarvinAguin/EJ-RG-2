...
# Registro de Reservas de Hotele
Este es un proyecto de sistema de Gstion de Reservas de Habitaciones 
#Mi proyecto
...
3 Cálculo de Estadía: Determina automáticamente el costo total de la reserva basándose en la tarifa por noche.
